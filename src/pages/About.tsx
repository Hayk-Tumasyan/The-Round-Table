  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-20">
      <div className="text-center mb-20">
        ...
        {/* FIXED: All keys are now lowercase to match JSON master files */}
        <h1 className="text-5xl md:text-6xl font-bold medieval-font text-zinc-100 uppercase mb-6">
          {t('about.title')}
        </h1>
      ...
      <div className="bg-[#1c120d] border border-zinc-800 rounded-3xl p-8 md:p-12 shadow-inner">
        <h3 className="text-center text-zinc-100 font-bold uppercase tracking-[0.3em] mb-12">
          {t('about.pillars_title')}
        </h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div className="text-center space-y-4">
            <Users className="w-8 h-8 text-amber-600 mx-auto" />
            <p className="text-zinc-400 text-sm px-4">{t('about.pillar_1')}</p>
          </div>
          <div className="text-center space-y-4 border-y md:border-y-0 md:border-x border-zinc-900 py-8 md:py-0 md:px-8">
            ...
            <p className="text-zinc-400 text-sm px-4">{t('about.pillar_2')}</p>
          </div>
          <div className="text-center space-y-4">
            <BookOpen className="w-8 h-8 text-amber-600 mx-auto" />
            <p className="text-zinc-400 text-sm px-4">{t('about.pillar_3')}</p>
          </div>
        </div>
      </div>
    </div>
