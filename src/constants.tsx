...
import { Product, Post, Tournament } from './types';
...
export const MOCK_TOURNAMENTS: Tournament[] = [
  {
    id: '1',
    title: 'The Grand Joust of Camelot',
    description: 'A display of chivalry and skill. Knights from across the realm gather to compete for the Golden Laurel.',
    date: 'Spring Equinox, 1224',
    location: 'Camelot Arena',
    prize: '5,000 Gold Pieces & The Golden Laurel',
    status: 'Upcoming'
  },
  {
    id: '2',
    title: 'Melee at Ironhold',
    description: 'A brutal test of strength and endurance in the mud and blood of the Ironhold pits.',
    date: 'Midsummer Eve, 1224',
    location: 'Ironhold Fortress',
    prize: 'Ancestral Blade of Ironhold',
    status: 'Upcoming'
  }
];